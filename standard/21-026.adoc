...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/is/COG/1.0
|Internal reference number of this OGC(R) document:    21-026
|Version: 1.0
...
include::clause_7_geotiff_format_text.adoc[]

include::clause_8_http_range_text.adoc[]
